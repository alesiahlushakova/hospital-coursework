...
public class UserDao {
    ...
    public Long findCountUsers() {
        ...
        Root<User> userRoot = criteriaQuery.from(User.class);
        return entityManager.createQuery(criteriaQuery.select(criteriaBuilder.count(criteriaQuery.from(User.class))).where(criteriaBuilder.equal(userRoot.get("role"), 1)))
                .getSingleResult();
    }
