...
import {findAllUserOrder, getAllDoctors, getAllUsers} from '../../util/APIUtils';
import Doctor from '../Doctor';
import SearchLogic from "./SearchLogic";
import withRouter from "react-router/lib/withRouter";
import { Pagination } from 'antd';
import Patient from "../Illness/Patient";
        ...
        return (
            ...
            <div className="doctors-container">
                <div className="doctors-container-header">
                    Doctor quantity  {this.state.doctors.length}
                    <span>
                          User quantity  {this.state.users.length}
                    </span>
